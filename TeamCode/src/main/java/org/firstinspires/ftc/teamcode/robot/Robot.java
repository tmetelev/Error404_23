...
import org.firstinspires.ftc.teamcode.OpenCV.AprilTagAutonomousInitDetection;
...
//        tele.update();
    ...
    public void teleLoop() throws InterruptedException {
        while (li.opModeIsActive()) {
            ...
            elv.ElevatorMove(gamepad2.right_stick_y * 0.5);
            ...
            tele.addData("encoder", elv.elevator.getCurrentPosition());
            tele.update();
        }
    }
}
